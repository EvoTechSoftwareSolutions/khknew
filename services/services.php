...
<body>
    ...
    <section class="ser--sec1">
        ...
        <div class="ser--sec1--div1">
            <div class="ser--sec1--div2">ABOUT US</div>
            <div class="ser--sec1--div3">
                KHK Tours is your gateway to unforgettable travel experiences in Sri Lanka and
                ...
                delivering exceptional service and creating stories you'll cherish for a lifetime.
    ...
    <section class="ser--sec2">

        <div class="ser--sec2--div1">

            <div class="ser--sec2--div9">


                <div class="ser--sec2--container">

                    <div class="ser--sec4--div6">
                        <span class="ser--sec4--span1">Islandwide Coverage</span>
                        <span class="ser--sec4--span2">Explore every corner of Sri Lanka with our islandwide services.
                            From
                    ...
                    <div class="ser--sec4--div6">
                        <span class="ser--sec4--span1">Competitive Price</span>
                        <span class="ser--sec4--span2">
                    ...
                    <div class="ser--sec4--div6">
                        <span class="ser--sec4--span1">24 h Service</span>
                        <span class="ser--sec4--span2">
                    ...
                    <div class="ser--sec4--div6">
                        <span class="ser--sec4--span1">CUSTOMER FRIENDLY</span>
                        <span class="ser--sec4--span2">
                            Your peace of mind is our priority!we’re here to provide reliable support and assistance
                            whenever you need it, making every moment of your journey effortless and stress-free.</span>
                    </div>
                    <div class="ser--sec4--div6">
                        <span class="ser--sec4--span1">GURANTEED SERVICE</span>
                        <span class="ser--sec4--span2">
                            Guaranteed service you can trust! We're here to ensure smooth and hassle-free support
                            whenever you need us, every step of the way.</span>
                    </div>
    ...
    <section class="ser--sec3">

        <div class="ser--sec3--div1">

...
<body>
    ...
    <div class="banner">
        <img src="../resources/img/banner.png" class="bannerimg">
    </div>
    <section class="tourpack-sec1">
        ...
        <div class="cardContainer">
            ...
            <article class="productCard">
                ...
                <div class="todo--readmoreRow">
                    <button class="todo--readmore" onclick="readmore(18);" id="card--showMore18">Read&nbsp;More&nbsp;&#11167;</button>
                    <button class="todo--readmore" onclick="readless(18);" id="card--showLess18" hidden>Show&nbsp;Less&nbsp;&#11165;</button>
                </div>
            </article>
